    ...
    >
      ...
      >
        <div className="text-gray text-center font-regular mt-8 md:text-xl md:w-3/4">
          Check this portfolio website code in{" "}
          <a
            href="https://github.com/singhgrtj/next-portfolio"
          ...
          and the design in{" "}
          <a
            href="https://www.figma.com/file/Q9fy0NKXRHbuaLrnP4j640/Next-JS-Portfolio?node-id=0%3A1"
            className="underline font-bold"
          >
            figma
          </a>
