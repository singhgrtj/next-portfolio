  ...
  return (
    <section className="px-4 py-6 w-full md:px-28 md:min-h-screen" id="welcome">
      ...
      <div className="flex justify-end md:hidden">
        <button
          className="flex items-center justify-center w-40 h-12 border-2 border-primary bg-secondary rounded-lg"
          onClick={downloadCV}
        >
          <BsDownload size={20} />
          <div className="font-semibold text-sm ml-4">Download CV</div>
        </button>
      </div>
      ...
      <div className="flex flex-col items-center w-full pt-8 md:flex-row-reverse md:items-center md:justify-center md:h-screen md:pt-0">
        ...
        >
          <div
            className="bg-cover bg-no-repeat h-64 w-full rounded-lg md:h-[26rem]"
        ...
        >
          <div className="flex justify-between md:justify-start">
            <ContactTags
              title="+34 632 97 79 68"
              icon={<IoCall />}
              responsiveIcon={<IoCall size={25} />}
            />
            <ContactTags
              title="singhgrtj@gmail.com"
              icon={<IoMail />}
              responsiveIcon={<IoMail size={25} />}
            />
          </div>
          <div className="flex flex-col items-center mt-6 md:items-start">
            ...
            <div className="text-5xl font-extrabold text-primary mt-2 md:text-7xl">
              SINGH
            </div>
          </div>
