            ...
            <section className="px-4 py-6 w-full md:px-28 md:min-h-screen bg-secondary md:flex md:flex-row md:pt-36" id="contact">
                ...
                <motion.div 
                    ...
                    <div className="hidden md:flex md:ml-2 md:mt-8">
                        <div className="mr-2">
                            <IoLogoLinkedin size={60} onClick={() => window.open("https://www.linkedin.com/in/singhgrtj/", "_blank")}/>
                        </div>
                        <div className="cursor-pointer">
                            <IoLogoGithub size={60} onClick={() => window.open("https://github.com/singhgrtj", "_blank")}/>
                        </div>
                    </div>
                </motion.div>
                ...
                <motion.div 
                    ...
                    <div className="mt-2 self-start">
                        <button className="w-36 h-10 bg-primary text-base font-semibold rounded-lg md:w-44 md:h-14 md:text-lg hover:border-2 hover:border-primary hover:bg-secondary" onClick={submitForm} disabled={loading}>
                            Contact me
                        </button>
                        {
                            error ? 
