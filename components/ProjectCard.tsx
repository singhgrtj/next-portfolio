...
const ProjectCard: React.FC<Props> = (props) => {
    ...
    return (
        <div className="flex flex-col w-full items-center pb-4 shadow-lg rounded-lg bg-white mt-4 hover:cursor-pointer hover:transition hover:duration-75">
            ...
            <div className="mt-6">
                <Button title={button} url={url} next_link={false}/>
            </div>
